...
using ms.answer.api.Helpers.Repositories.Mappings;
using ms.answer.api.Helpers.Services.Blocks;
using ms.answer.api.Helpers.Services.Blocks.Answers.Contracts;
using ms.answer.api.Helpers.Services.Blocks.Answers.Impls;
using NHibernate;
...
namespace ms.answer.api.Configurations
{
    ...
    public static void ConfigureNHibernate(IServiceCollection services, string connectionString)
    {
      try
      {
        var cfg = Fluently.Configure()
          ...
          .Mappings(x => x.FluentMappings.AddFromAssemblyOf<AnswerMap>())
