...
using ms.category.api.Configurations;
using ms.category.api.Configurations.AutoMappingProfiles.Categories;
  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddSwaggerGen(c =>
      {
        ...
        {
          Title = "ms.category.qa99.api - HTTP API",
          Version = "v1",
          Description = "The Catalog Microservice HTTP API for ms.category.qa99.api service",
        });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
    {
      ...
      app.UseSwagger()
        .UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "ms.category.qa99.api - API V1"); });
