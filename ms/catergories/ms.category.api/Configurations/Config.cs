...
using ms.category.api.Helpers.Repositories.Mappings;
...
using ms.category.api.Helpers.Services.Blocks.Categories.Impls;
using NHibernate;
...
namespace ms.category.api.Configurations
{
