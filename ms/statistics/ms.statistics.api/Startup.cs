...
using soa.statistics.api.Configurations;
using soa.statistics.api.Configurations.AutoMappingProfiles.Answers;

namespace soa.statistics.api
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddSwaggerGen(c =>
      {
        ...
        {
          Title = "soa.statistics.qa99.api - HTTP API",
          Version = "v1",
          Description = "The Catalog Microservice HTTP API for soa.statistics.qa99.api service",
        });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
    {
      ...
      app.UseSwagger()
        .UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "soa.statistics.qa99.api - API V1"); });
      ...
      {
        cfg.AddProfile<StatisticEntityToStatisticUiAutoMapperProfile>();
      });
