...
using soa.auth.api.Configurations;
using soa.auth.api.Configurations.AutoMappingProfiles.Answers;
  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddSwaggerGen(c =>
      {
        ...
        {
          Title = "soa.auth.qa99.api - HTTP API",
          Version = "v1",
          Description = "The Catalog Microservice HTTP API for soa.auth.qa99.api service",
        });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime lifetime)
    {
      ...
      app.UseSwagger()
        .UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "soa.auth.qa99.api - API V1"); });
