...
namespace soa.statistics.api.Controllers.API.V1
{
  ...
  public class StatisticsController : BaseController
  {
    ...
    private readonly IUpdateStatisticProcessor _updateStatisticProcessor;
    private readonly IDeleteStatisticProcessor _deleteStatisticProcessor;
      ...
      IStatisticsControllerDependencyBlock blockStatistic)
    {
      ...
      _updateStatisticProcessor = blockStatistic.UpdateStatisticProcessor;
      _deleteStatisticProcessor = blockStatistic.DeleteStatisticProcessor;
    }
