...
namespace smart.charger.webui.Pages.Vehicles.VehicleDetails
{
  public class VehicleDetailsViewModel : FluxorComponent
  {
    ...
    public IEnumerable<VehicleChargerConnectionType> ConnectionTypeData { get; set; } = new List<VehicleChargerConnectionType>()
    {
