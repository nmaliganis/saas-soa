...
namespace soa.ui.Services.Impls.Tags
{
  public class TagDataService : ITagDataService
  {
    ...
    public Task<TagDto> CreateTag(TagForCreationDto tagToBeCreated)
    {
      throw new System.NotImplementedException();
    }

    public Task<TagDto> UpdateTag(Guid tagIdToBeUpdated, TagForModificationDto tagToBeUpdated)
    {
      throw new System.NotImplementedException();
    }

    public Task<TagDto> DeleteTag(Guid tagIdToBeDeleted)
    {
      throw new System.NotImplementedException();
    }
  }
