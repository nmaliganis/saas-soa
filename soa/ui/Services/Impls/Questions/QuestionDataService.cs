    ...
    public class QuestionDataService : IQuestionDataService
    {
        ...
        public async Task<List<QuestionDto>> GetQuestionList(string authorizationToken = null)
        {
            ...
            try
            {
                ...
                {
                    QuestionErrorModel resultError =
                        JsonConvert.DeserializeObject<QuestionErrorModel>(response.Content);
        ...
        public async Task<List<QuestionDto>> GetQuestionTodayList(string authorizationToken = null)
        {
            List<QuestionDto> result = new List<QuestionDto>();
        ...
        public async Task<List<QuestionDto>> GetQuestionUnansweredList(string authorizationToken = null)
        {
            List<QuestionDto> result = new List<QuestionDto>();

            var client = new RestClient($"{BaseAddr}/api/questions/unanswered");
            var request = new RestRequest(Method.GET);
        ...
        public Task<QuestionDto> UpdateQuestion(Guid questionIdToBeUpdated,
            QuestionForModificationDto questionToBeUpdated)
        {
        ...
        public async Task<int> FetchQuestionsTodayTotalCount(string authorizationToken = null)
        {
            ...
            var client = new RestClient($"{BaseAddr}/api/Questions/count-today");
            var request = new RestRequest(Method.GET);
